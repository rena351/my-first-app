...
export default function AppPage() {
  ...
  const { data: sidebarData, isLoading: sidebarLoading } = useQuery<string>({
  ...
  if (appLoading || categoryLoading || sidebarLoading) {
    return (
  ...
  return (
    <div className="min-h-screen bg-aura-dark">
      ...
      <div className="flex">
        ...
        <TwoLevelSidebar sidebarData={sidebarData!} appName={app.name} currentPage="Dashboard" />
