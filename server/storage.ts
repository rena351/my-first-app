...
export class MemStorage implements IStorage {
  ...
  private initializeApps() {
    ...
    const appsData: Array<Omit<App, 'id'>> = [
      ...
      // Newly added apps
      { name: "Contacts", description: "Contact management", categoryId: categories.find(c => c.name === "Email & Collaboration")!.id, icon: "fas fa-address-book", features: ["Contact Management", "Grouping", "Syncing"], shortcuts: ["All Contacts", "Groups", "Settings"] },
      { name: "Finances", description: "Personal and business finance management", categoryId: categories.find(c => c.name === "Finance")!.id, icon: "fas fa-file-invoice-dollar", features: ["Income Tracking", "Expense Management", "Budgeting"], shortcuts: ["Dashboard", "Transactions", "Budgets", "Reports"] },
      { name: "MarketingHub", description: "Unified marketing platform", categoryId: categories.find(c => c.name === "Marketing")!.id, icon: "fas fa-lightbulb", features: ["Lead Management", "Email Campaigns", "Marketing Automation"], shortcuts: ["Dashboard", "Leads", "Campaigns", "Analytics"] },
      { name: "Motivator", description: "Sales motivation platform", categoryId: categories.find(c => c.name === "Sales")!.id, icon: "fas fa-trophy", features: ["Gamification", "Performance Tracking", "Leaderboards"], shortcuts: ["Dashboard", "Games", "Leaderboards", "Reports"] },
      { name: "Reports", description: "Advanced reporting and analytics", categoryId: categories.find(c => c.name === "BI & Analytics")!.id, icon: "fas fa-chart-area", features: ["Custom Reports", "Data Visualization", "Scheduled Reports"], shortcuts: ["All Reports", "Dashboards", "Scheduler", "Settings"] },
      { name: "Subscriptions", description: "Subscription billing management", categoryId: categories.find(c => c.name === "Finance")!.id, icon: "fas fa-sync-alt", features: ["Subscription Plans", "Recurring Billing", "Customer Portal"], shortcuts: ["Dashboard", "Subscriptions", "Customers", "Reports"] },
      { name: "Tasks", description: "Task management for teams", categoryId: categories.find(c => c.name === "Project Management")!.id, icon: "fas fa-tasks", features: ["Task Lists", "Project Association", "Collaboration"], shortcuts: ["My Tasks", "Projects", "Calendar", "Reports"] },
      { name: "Wiki", description: "Team knowledge base", categoryId: categories.find(c => c.name === "Email & Collaboration")!.id, icon: "fas fa-book-open", features: ["Knowledge Management", "Collaborative Editing", "Version History"], shortcuts: ["Home", "Pages", "Categories", "Search"] }
    ];
