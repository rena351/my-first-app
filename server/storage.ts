...
export class MemStorage implements IStorage {
  ...
  private initializeApps() {
    ...
    const appsData: Array<Omit<App, 'id'>> = [
      ...
      { name: "SalesInbox", description: "Email client for salespeople", categoryId: categories.find(c => c.name === "Sales")!.id, icon: "fas fa-inbox", features: ["Email for Salespeople", "CRM Integration", "Email Tracking", "Sales Insights"], shortcuts: ["Deals", "Leads", "Contacts", "Not in CRM", "Colleagues"] },
      { name: "Motivator", description: "Sales motivation platform", categoryId: categories.find(c => c.name === "Sales")!.id, icon: "fas fa-bullseye", features: ["Sales Gamification", "Performance Tracking", "Leaderboards", "Sales Contests"], shortcuts: ["Dashboard", "Games", "Leaderboards", "Achievements", "Analytics", "Setup"] },
      ...
      { name: "MarketingHub", description: "All-in-one marketing automation software", categoryId: categories.find(c => c.name === "Marketing")!.id, icon: "fas fa-cogs", features: ["Lead Nurturing", "Marketing Automation", "Campaign Management", "Analytics"], shortcuts: ["Dashboard", "Campaigns", "Lead Management", "Content", "Automation", "Analytics", "Integration", "Settings"] },
      ...
      { name: "Subscriptions", description: "Recurring billing and subscription management", categoryId: categories.find(c => c.name === "Finance")!.id, icon: "fas fa-sync-alt", features: ["Subscription Management", "Recurring Billing", "Payment Automation", "Subscription Analytics"], shortcuts: ["Dashboard", "Subscriptions", "Customers", "Plans", "Billing", "Analytics", "Settings"] },
      { name: "Finances", description: "Financial overview and budgeting tool", categoryId: categories.find(c => c.name === "Finance")!.id, icon: "fas fa-dollar-sign", features: ["Financial Overview", "Budgeting", "Expense Tracking", "Financial Reports"], shortcuts: ["Dashboard", "Transactions", "Accounts", "Budgeting", "Reports", "Reconciliation", "Tax Management", "Settings"] },
      ...
      { name: "MDM", description: "Mobile Device Management software", categoryId: categories.find(c => c.name === "Security & IT")!.id, icon: "fas fa-mobile-alt", features: ["Device Management", "Security Policies", "App Distribution", "Remote Wipe"], shortcuts: ["Dashboard", "Devices", "Enrollment", "Policies", "Applications", "Security", "Reports"] },
      ...
      { name: "Reports", description: "Cross-functional business reports", categoryId: categories.find(c => c.name === "BI & Analytics")!.id, icon: "fas fa-chart-pie", features: ["Cross-functional Reports", "Sales Analytics", "Marketing Analytics", "Custom Dashboards"], shortcuts: ["Folders", "Account and Contact Reports", "Deal Reports", "Lead Reports", "Campaign Reports"] },
